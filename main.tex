...
\begin{frame}[plain]\small\frametitle{Sommario}
...
\begin{frame}[plain]\small\frametitle{Bibliografia}
\begin{itemize}
...
\end{frame}
\begin{frame}[plain,allowframebreaks]\small\frametitle{chat-GPT}
